...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Total success rate of all sites')
        return fig
    else:
        ...
        names='class_label', 
        title='Success vs. Failed counts at {}'.format(entered_site),
        )
        return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df_1=filtered_df_1[(filtered_df_1['Payload Mass (kg)'] >= payload_range[0]) & (filtered_df_1['Payload Mass (kg)'] <= payload_range[1])]
         
        fig = px.scatter(filtered_df_1, x='Payload Mass (kg)', 
        y='class', 
        color='Booster Version Category',
        title='Correlation between Payload mass and Class at {}'.format(entered_site),
        )
        return fig
# Run the app
