{
 "cells": [
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "data_1=pd.DataFrame(launch_dict)"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "data_falcon9= pd.DataFrame(data[data['BoosterVersion']=='Falcon 9'])"
   ]
  },
  {
   "cell_type": "code",
  ...
  },
  {
   ...
   "source": [
    ...
    "data_falcon9.reset_index(drop='True')"
   ]
  },
  {
   "cell_type": "markdown",
  ...
  },
  {
   ...
   "source": [
    ...
    "mean= data_falcon9['PayloadMass'].astype('float').mean(axis=0)\n",
